            ...
            <ul className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 list-none p-0 m-0 rounded-lg'>
              {products.map((product) => {
                ...
                return (
                  ...
                  <li key={product.id} className="card relative overflow-hidden bg-white rounded-lg shadow-lg flex flex-col gap-4 p-0 transform hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="p-4"> {/* better spacing */}
                      <h3 className="font-bold text-lg mb-2">{product.title}</h3>
                      <p className="text-gray-600 text-sm">{product.description}</p>
                    </div>

                    <div className="flip-container p-4">
                        ...
                        <div className="flip-box-back">
                          <RouterLink to='/editaloTuMismo' state={{ selectedProduct: product }}>
                            <button
                              ...
                              /*  onClick={() => {   descomentar para anadir a la carta 
